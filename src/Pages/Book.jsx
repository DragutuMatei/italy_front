...
function Book() {
  ...
  // === PERSISTENȚĂ BOOKING DOAR LOCALSTORAGE ===
  // Funcție pentru salvare date user în localStorage
  const saveUserData = (userData) => {
    localStorage.setItem("bookData", JSON.stringify(userData));
  };

  // Funcție pentru restaurare date user din localStorage
  ...
  const [hasPaid, setHasPaid] = useState(false); // Adaugă această linie la începutul funcției Book
  ...
  // === Setează hasPaid pe true când plata a fost efectuată ===
  useEffect(() => {
          ...
          <>
            ...
            <div className="select ">
              <div className="masini plus">
                ...
                <h3>
                  <FaCheckCircle /> The vehicle images above are examples. You
                  may get a different vehicle of similar quality.
                </h3>
              </div>
            </div>
          </>
            ...
            {checked === "some" && (
              <div className="select ">
                ...
                <div className="masini plus">
                  ...
                  <h3>
                    Please enter the phone number on which the guest would like
