...
function Terms() {
  return (
    <div className="terms">
      ...
      <p>Updated at 2025-07-24</p>

      <h1>General Terms</h1>
      <p>
        By accessing and placing an order with Trevi Chauffeurs, you confirm
        ...
        you and Trevi Chauffeurs.
      </p>
      <p>
        Under no circumstances shall Trevi Chauffeurs team be liable for any
        ...
        Trevi Chauffeurs team or an authorized representative has been advised
      ...
      <h1>License</h1>
      <p>
        Trevi Chauffeurs grants you a revocable, non-exclusive,
      ...
      <p>
        These Terms & Conditions are a contract between you and Trevi Chauffeurs
        (referred to in these Terms & Conditions as "Trevi Chauffeurs", "us",
        "we" or "our"), the provider of the Trevi Chauffeurs website and the
        services accessible from the Trevi Chauffeurs website (which are
        collectively referred to in these Terms & Conditions as the "Trevi
        Chauffeurs Service").
      </p>
      <p>
        You are agreeing to be bound by these Terms & Conditions. If you do not
        agree to these Terms & Conditions, please do not use the Trevi
        Chauffeurs Service. In these Terms & Conditions, "you" refers both to
        you as an individual and to the entity you represent. If you violate any
        of these Terms & Conditions, we reserve the right to cancel your account
      ...
      <ul>
        ...
        <li>
          ...
          refers to Trevi Chauffeurs, italy that is responsible for your
          information under this Terms & Conditions.
        </li>
        <li>
          Country: where Trevi Chauffeurs or the owners/founders of Trevi
          Chauffeurs are based, in this case is{" "}
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit Trevi
          Chauffeurs and use the services.
        </li>
        <li>
          Service: refers to the service provided by Trevi Chauffeurs as
        ...
        <li>
          Website: Trevi Chauffeurs's site, which can be accessed via this URL:
          https://trevi-chauffeurs.com/
        </li>
        <li>
          You: a person or entity that is registered with Trevi Chauffeurs to
          use the Services.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of Trevi Chauffeurs or its affiliates,
          partners, suppliers or the licensors of the website.
        </li>
      </ul>
      <h1>Return and Refund Policy</h1>
      <p>
        Thanks for shopping at Trevi Chauffeurs. We appreciate the fact that you
      ...
      <p>
        ...
        apply to transactions at Trevi Chauffeurs. We’ll be as brief as our
        attorneys will allow. The main thing to remember is that by placing an
        order or making a purchase at Trevi Chauffeurs, you agree to the terms
        along with Trevi Chauffeurs's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, "Suggestions") provided by you to Trevi Chauffeurs with
        respect to the website shall remain the sole and exclusive property of
        Trevi Chauffeurs.
      </p>
      <p>
        Trevi Chauffeurs shall be free to use, copy, modify, publish, or
      ...
      <p>
        ...
        contain links to other websites not operated or controlled by Trevi
        Chauffeurs. We are not responsible for the content, accuracy or opinions
      ...
      <h1>Cookies</h1>
      <p>
        Trevi Chauffeurs uses "Cookies" to identify the areas of our website
      ...
      <p>
        You acknowledge and agree that Trevi Chauffeurs may stop (permanently or
        ...
        specifically inform Trevi Chauffeurs when you stop using the Service.
        You acknowledge and agree that if Trevi Chauffeurs disables access to
      ...
      <p>
        Trevi Chauffeurs reserves the right to modify, suspend or discontinue,
      ...
      <p>
        Trevi Chauffeurs may from time to time provide enhancements or
      ...
      <p>
        ...
        the website. You agree that Trevi Chauffeurs has no obligation to (i)
      ...
      <p>
        You acknowledge and agree that Trevi Chauffeurs shall not be responsible
        ...
        or any other aspect thereof. Trevi Chauffeurs does not assume and shall
      ...
      <p>
        This Agreement shall remain in effect until terminated by you or Trevi
        Chauffeurs.
      </p>
      <p>
        Trevi Chauffeurs may, in its sole discretion, at any time and for any or
      ...
      <p>
        ...
        Trevi Chauffeurs, in the event that you fail to comply with any
      ...
      <p>
        Termination of this Agreement will not limit any of Trevi Chauffeurs's
      ...
      <p>
        You agree to indemnify and hold Trevi Chauffeurs and its parents,
      ...
      <p>
        ...
        permitted under applicable law, Trevi Chauffeurs, on its own behalf and
        ...
        Without limitation to the foregoing, Trevi Chauffeurs provides no
      ...
      <p>
        Without limiting the foregoing, neither Trevi Chauffeurs nor any Trevi
        Chauffeurs's provider makes any representation or warranty of any kind,
        ...
        servers, the content, or e-mails sent from or on behalf of Trevi
        Chauffeurs are free of viruses, scripts, trojan horses, worms, malware,
      ...
      <p>
        ...
        of Trevi Chauffeurs and any of its suppliers under any provision of this
      ...
      <p>
        ...
        Trevi Chauffeurs or its suppliers be liable for any special, incidental,
        ...
        this Agreement), even if Trevi Chauffeurs or any supplier has been
      ...
      <p>
        ...
        notices published by Trevi Chauffeurs on the Services, shall constitute
        the entire agreement between you and Trevi Chauffeurs concerning the
        ...
        term or any other term, and Trevi Chauffeurs's failure to assert any
        right or provision under this Agreement shall not constitute a waiver of
        such right or provision. YOU AND Trevi Chauffeurs AGREE THAT ANY CAUSE
      ...
      <p>
        Trevi Chauffeurs reserves the right, at its sole discretion, to modify
      ...
      <p>
        ...
        agree to the new terms, you are no longer authorized to use Trevi
        Chauffeurs.
      </p>

      <h1>Entire Agreement</h1>
      <p>
        The Agreement constitutes the entire agreement between you and Trevi
        Chauffeurs regarding your use of the website and supersedes all prior
        and contemporaneous written or oral agreements between you and Trevi
        Chauffeurs.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other Trevi Chauffeurs's services, which Trevi
        Chauffeurs will provide to you at the time of such use or purchase.
      </p>
      ...
      <p>
        ...
        thereof), are owned by Trevi Chauffeurs, its licensors or other
        ...
        in part, without the express prior written permission of Trevi
        Chauffeurs, unless and except as is expressly provided in these Terms &
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Trevi Chauffeurs's INTELLECTUAL
        PROPERTY RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and Trevi Chauffeurs concerning the Services or
      ...
      <p>
        In the event of a dispute, you or Trevi Chauffeurs must give the other a
        ...
        <a href="mailto:nrc.servizi@gmail.com">nrc.servizi@gmail.com</a>. Trevi
        Chauffeurs will send any Notice of Dispute to you by mail to your
        address if we have it, or otherwise to your email address. You and Trevi
        Chauffeurs will attempt to resolve any dispute through informal
        negotiation within sixty (60) days from the date the Notice of Dispute
        is sent. After sixty (60) days, you or Trevi Chauffeurs may commence
        arbitration.
      </p>

      <h1>Binding Arbitration</h1>
      <p>
        If you and Trevi Chauffeurs don’t resolve any dispute by informal
      ...
      <p>
        ...
        and will become the sole property of Trevi Chauffeurs without any
        compensation or credit to you whatsoever. Trevi Chauffeurs and its
      ...
      <h1>Promotions</h1>
      <p>
        Trevi Chauffeurs may, from time to time, include contests, promotions,
      ...
      <p>
        ...
        of Trevi Chauffeurs. Trevi Chauffeurs will be entitled to injunctive or
        other equitable relief (without the obligations of posting any bond or
        surety) in the event of any breach or anticipatory breach by you. Trevi
        Chauffeurs operates and controls the Trevi Chauffeurs Service from its
        ...
        those persons who choose to access the Trevi Chauffeurs Service from
        ...
        Trevi Chauffeurs Privacy Policy) contains the entire understanding, and
        supersedes all prior understandings, between you and Trevi Chauffeurs
      ...
      <h1>Disclaimer</h1>
      <p>
        Trevi Chauffeurs is not responsible for any content, code or any other
        imprecision.
      </p>
      <p>Trevi Chauffeurs does not provide warranties or guarantees.</p>
      <p>
        In no event shall Trevi Chauffeurs be liable for any special, direct,
      ...
      <p>
        The Trevi Chauffeurs Service and its contents are provided "as is" and
        "as available" without any warranty or representations of any kind,
        whether express or implied. Trevi Chauffeurs is a distributor and not a
        publisher of the content supplied by third parties; as such, Trevi
        Chauffeurs exercises no editorial control over such content and makes no
        ...
        accessible via the Trevi Chauffeurs Service. Without limiting the
        foregoing, Trevi Chauffeurs specifically disclaims all warranties and
        representations in any content transmitted on or in connection with the
        Trevi Chauffeurs Service or on sites that may appear as links on the
        Trevi Chauffeurs Service, or in the products provided as a part of, or
        otherwise in connection with, the Trevi Chauffeurs Service, including
        without limitation any warranties of merchantability, fitness for a
        particular purpose or non-infringement of third party rights. No oral
        advice or written information given by Trevi Chauffeurs or any of its
        ...
        change without notice. Without limiting the foregoing, Trevi Chauffeurs
        does not warrant that the Trevi Chauffeurs Service will be
